...
execute if items entity @s player.cursor *[custom_data~{last_page:1b}] if score @s page matches 1.. run scoreboard players operation @s page = $pages page
execute if items entity @s player.cursor *[custom_data~{first_page:1b}] if score @s page matches 1.. run scoreboard players set @s page 0
