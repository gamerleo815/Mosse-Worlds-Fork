...
item replace entity @s enderchest.20 with player_head[custom_data={custom_ui:1b, first_page:1b}, profile={properties:[{name:"textures", value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGMzMDFhMTdjOTU1ODA3ZDg5ZjljNzJhMTkyMDdkMTM5M2I4YzU4YzRlNmU0MjBmNzE0ZjY5NmE4N2ZkZCJ9fX0="}]}, max_stack_size=1]
item replace entity @s enderchest.21 with player_head[custom_data={custom_ui:1b, previous_page:1b}, profile={properties:[{name:"textures", value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDgzNDhhYTc3ZjlmYjJiOTFlZWY2NjJiNWM4MWI1Y2EzMzVkZGVlMWI5MDVmM2E4YjkyMDk1ZDBhMWYxNDEifX19"}]}, max_stack_size=1]
...
item replace entity @s enderchest.23 with player_head[custom_data={custom_ui:1b, next_page:1b}, profile={properties:[{name:"textures", value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWJjYTkwZWJhZmRmNTdkZjRjMzgwY2YyNjU1YWE3YjRlYzZhNGJkYmQxNTUxNmViZmRlNDMyN2ExZTI3In19fQ=="}]}, max_stack_size=1]
item replace entity @s enderchest.24 with player_head[custom_data={custom_ui:1b, last_page:1b}, profile={properties:[{name:"textures", value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTFjMWY1ZGNmNTZiMTlkOWY2ZDE4MGU5MjA1ZGE5ZDc2MGMxNGNhNTU4MTdmYjdjZjljZDFkYjE3NzI4NTUxIn19fQ=="}]}, max_stack_size=1]
...
scoreboard players operation $offset page = @s page
scoreboard players operation $offset page *= 18 numbers
function legitermoose:world_browser/render/render_item {offset:0}
function legitermoose:world_browser/render/render_item {offset:1}
function legitermoose:world_browser/render/render_item {offset:2}
function legitermoose:world_browser/render/render_item {offset:3}
function legitermoose:world_browser/render/render_item {offset:4}
function legitermoose:world_browser/render/render_item {offset:5}
function legitermoose:world_browser/render/render_item {offset:6}
function legitermoose:world_browser/render/render_item {offset:7}
function legitermoose:world_browser/render/render_item {offset:8}
function legitermoose:world_browser/render/render_item {offset:9}
function legitermoose:world_browser/render/render_item {offset:10}
function legitermoose:world_browser/render/render_item {offset:11}
function legitermoose:world_browser/render/render_item {offset:12}
function legitermoose:world_browser/render/render_item {offset:13}
function legitermoose:world_browser/render/render_item {offset:14}
function legitermoose:world_browser/render/render_item {offset:15}
function legitermoose:world_browser/render/render_item {offset:16}
function legitermoose:world_browser/render/render_item {offset:17}